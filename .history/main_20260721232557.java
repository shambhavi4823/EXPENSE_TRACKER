...
public class main {
   ...
   private static void configureCorsHeaders(HttpExchange var0) {
      ...
      var0.getResponseHeaders().add("Access-Control-Allow-Methods", "POST, OPTIONS, GET");
   ...
   static class AdminAnalyticsHandler implements HttpHandler {
      public void handle(HttpExchange var1) throws IOException {
         ...
         } else if ("POST".equalsIgnoreCase(var1.getRequestMethod()) || "GET".equalsIgnoreCase(var1.getRequestMethod())) {
   ...
   static class RegisterHandler implements HttpHandler {
      public void handle(HttpExchange var1) throws IOException {
         ...
         if ("OPTIONS".equalsIgnoreCase(var1.getRequestMethod())) {
            ...
            String var4;
            try {
               (new UserDAO()).registeruser((String)var3.get("name"), (String)var3.get("email"), (String)var3.get("password"), (String)var3.get("role"));
               var4 = "{\"status\":\"success\"}";
               var1.sendResponseHeaders(200, (long)var4.getBytes(StandardCharsets.UTF_8).length);
            } catch (Exception var6) {
               var4 = "{\"status\":\"error\",\"message\":\"Registration Error Exception.\"}";
               var1.sendResponseHeaders(400, (long)var4.getBytes(StandardCharsets.UTF_8).length);
            }
   ...
   static class LoginHandler implements HttpHandler {
      public void handle(HttpExchange var1) throws IOException {
         ...
         if ("OPTIONS".equalsIgnoreCase(var1.getRequestMethod())) {
            ...
            String var2 = new String(var1.getRequestBody().readAllBytes(), StandardCharsets.UTF_8);
            Map var3 = main.parseFormData(var2);
            int var4 = (new UserDAO()).loginuser((String)var3.get("email"), (String)var3.get("password"));
            String var5;
            if (var4 == -1) {
               var5 = "{\"status\":\"error\",\"message\":\"Invalid details provided!\"}";
               var1.sendResponseHeaders(401, (long)var5.getBytes(StandardCharsets.UTF_8).length);
            } else {
               String var6 = !((String)var3.get("email")).toLowerCase().contains("admin") && !((String)var3.get("email")).equalsIgnoreCase("tushar@gmail.com") ? "user" : "admin";
               var5 = "{\"status\":\"success\",\"userId\":" + var4 + ",\"role\":\"" + var6 + "\",\"email\":\"" + (String)var3.get("email") + "\"}";
               var1.sendResponseHeaders(200, (long)var5.getBytes(StandardCharsets.UTF_8).length);
            }
            OutputStream var7 = var1.getResponseBody();
   ...
   static class AddExpenseHandler implements HttpHandler {
      public void handle(HttpExchange var1) throws IOException {
         ...
         if ("OPTIONS".equalsIgnoreCase(var1.getRequestMethod())) {
            ...
            Map var3 = main.parseFormData(var2);
            int var4 = Integer.parseInt((String)var3.get("userId"));
            String var5 = (String)var3.get("item_type");
            String var6 = (String)var3.get("item_name");
            int var7 = Integer.parseInt((String)var3.get("quantity"));
            double var8 = Double.parseDouble((String)var3.get("price"));
            String var10 = (new ExpenseDAO()).addExpense(var4, var5, var6, var7, var8);
            var1.sendResponseHeaders(200, (long)var10.getBytes(StandardCharsets.UTF_8).length);
            OutputStream var11 = var1.getResponseBody();
            var11.write(var10.getBytes(StandardCharsets.UTF_8));
            var11.close();
         }
      }
   }
   ...
   static class SearchExpensesHandler implements HttpHandler {
      public void handle(HttpExchange var1) throws IOException {
         ...
         if ("OPTIONS".equalsIgnoreCase(var1.getRequestMethod())) {
            ...
            Map var3 = main.parseFormData(var2);
            int var4 = Integer.parseInt((String)var3.get("userId"));
            String var5 = (String)var3.get("searchType");
            String var6 = (String)var3.get("keyword");
            String var7 = (new ExpenseDAO()).searchExpensesJson(var4, var5, var6);
            var1.sendResponseHeaders(200, (long)var7.getBytes(StandardCharsets.UTF_8).length);
            OutputStream var8 = var1.getResponseBody();
            var8.write(var7.getBytes(StandardCharsets.UTF_8));
            var8.close();
         }
      }
   }
   ...
   static class UpdateBudgetHandler implements HttpHandler {
      public void handle(HttpExchange var1) throws IOException {
         ...
         if ("OPTIONS".equalsIgnoreCase(var1.getRequestMethod())) {
            ...
            Map var3 = main.parseFormData(var2);
            int var4 = Integer.parseInt((String)var3.get("userId"));
            double var5 = Double.parseDouble((String)var3.get("newBudget"));
   ...
   static class ChangePasswordHandler implements HttpHandler {
      public void handle(HttpExchange var1) throws IOException {
         ...
         if ("OPTIONS".equalsIgnoreCase(var1.getRequestMethod())) {
            ...
            Map var3 = main.parseFormData(var2);
            int var4 = Integer.parseInt((String)var3.get("userId"));
            String var5 = (String)var3.get("oldPass");
            String var6 = (String)var3.get("newPass");
